...
/*
-- Map<Integer, Set> keeps val:a set of indices in array list with same val
-- When remove, if current index < nums.size()-1, move lastVal to current index, update map, delete last item
...
class RandomizedCollection {
    ...
    public boolean remove(int val) {
        ...
        if (index < nums.size()-1) {//move last elemen to current index
